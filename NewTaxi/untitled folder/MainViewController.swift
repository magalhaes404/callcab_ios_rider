...
class MainViewController: UIViewController, PayPalPaymentDelegate, PayPalFuturePaymentDelegate, PayPalProfileSharingDelegate, FlipsideViewControllerDelegate {
  ...
  @IBOutlet weak var successView: UIView!
    ...
    var strTripID = ""
    let arrReceiptInfo = ["Base Fare","Distance Fare","Time Fare","Access Fee","Total Payout"]
    var arrCostInfo = [String]()
  ...
  @IBAction func buyClothingAction(_ sender: AnyObject) {
    ...
    let payment = PayPalPayment(amount: total, currencyCode: "USD", shortDescription: "mouni payment", intent: .sale)
